...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'dev.autologin' => 'boolean',
            'dev.autologin_user_id' => 'integer',
...
'view.compiled','concurrency.default','cors.paths','cors.allowed_methods','cors.allowed_origins',
...
'database.redis.cache.backoff_base','database.redis.cache.backoff_cap','dev.autologin','dev.autologin_user_id','filesystems.default',
...
'filesystems.disks.s3.report','filesystems.links./var/www/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware',
...
'login.show','login','logout','password.confirm','password.confirmation',
'password.confirm.store','items.index','items.detail','register',
'register.perform','purchase.confirm','purchase.perform','address.show','address.save',
'sell.show','sell.perform','mypage.profile','mypage.edit','mypage.save',
'comments.store','like.add','like.remove','stripe.webhook','storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.register','components.site-header','items.index','items.show',
'layouts.app','layouts.guest','mypage.profile','mypage.profile_edit','purchase.address_edit',
'purchase.confirm','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','DEV_AUTO_LOGIN',
'DEV_AUTO_LOGIN_USER_ID','STRIPE_KEY','STRIPE_SECRET','STRIPE_WEBHOOK_SECRET',);
